      ...
      <ul className="">
        ...
        <Link to="/TotalOrders">
          <li className="flex pl-[50px] pt-[12px] pb-[12px] items-center cursor-pointer hover:bg-[#75D1A4] ">
            ...
            <span className="text-white ml-2 font-semibold">Total Orders</span>
          </li>
        </Link>
        <Link to="TotalRefer">
          <li className="flex pl-[50px] pt-[12px] pb-[12px] items-center cursor-pointer hover:bg-[#75D1A4]">
            ...
            <span className="text-white ml-2 font-semibold">Refers/Coupon</span>
          </li>
        </Link>
        ...
        <Link to="/Allservices">
          <li className="flex  pl-[50px] pt-[12px] pb-[12px] items-center cursor-pointer hover:bg-[#75D1A4]">
            ...
            <span className="text-white ml-2 font-semibold">All Services</span>
          </li>
        </Link>
        ...
        <Link to="/TotalProducts">
          <li className="flex  pl-[50px] pt-[12px] pb-[12px] items-center cursor-pointer hover:bg-[#75D1A4]">
            ...
            <span className="text-white ml-2 font-semibold">All Products</span>
          </li>{" "}
        </Link>
        <Link to="/Banners">
          <li className="flex  pl-[50px] pt-[12px] pb-[12px] items-center cursor-pointer hover:bg-[#75D1A4]">
